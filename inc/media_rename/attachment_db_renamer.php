...
class Optml_Attachment_Db_Renamer {
  ...
  private function replace_image_urls($content, $old_url, $new_url) {
      ...
      if (!empty($old_ext)) {
          ...
          $content = preg_replace_callback($size_pattern, function($matches) use ($old_base, $new_base, $old_domain, $new_domain, $old_dir, $new_dir, $old_ext, $new_ext) {
          ...
          $content = preg_replace_callback($scaled_pattern, function($matches) use ($old_base, $new_base, $old_domain, $new_domain, $old_dir, $new_dir, $old_ext, $new_ext) {
          ...
          $content = preg_replace_callback($json_size_pattern, function($matches) use ($old_base, $new_base, $old_domain, $new_domain, $old_dir, $new_dir, $old_ext, $new_ext) {
              // Extract the size part (e.g., -300x200)
          ...
          $content = preg_replace_callback($json_scaled_pattern, function($matches) use ($old_base, $new_base, $old_domain, $new_domain, $old_dir, $new_dir, $old_ext, $new_ext) {
