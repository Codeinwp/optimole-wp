...
class Optml_Admin {
	...
	private function get_dashboard_strings() {
		return [
			...
			'your_api_key'                   => __( 'LOOKING FOR YOUR API KEY?', 'optimole-wp' ),
			...
			'optml_dashboard'                => sprintf( __( 'Get it from the %1$s Optimole Dashboard%2$s.', 'optimole-wp' ), '<a href="https://dashboard.optimole.com/" target="_blank"> ', '</a>' ),
