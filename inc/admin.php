...
The root cause might be either a security plugin which blocks this feature or some faulty server configuration which constrain this WordPress feature.You can try to disable any of the security plugins that you use in order to see if the issue persists or ask the hosting company to further investigate.',
			...
			'options_strings'                  => [
				...
				'offloading_stop_description'       => __( 'This will stop the process and will bring any transferred images from Optimole Cloud - back to your site. This may take a while.', 'optimole-wp' ),
				...
				'rollback_stop_description'         => __( 'Canceling the process will transfer your images in Optimole Cloud and may take a while, depending on the number of images.', 'optimole-wp' ),
