...
The root cause might be either a security plugin which blocks this feature or some faulty server configuration which constrain this WordPress feature.You can try to disable any of the security plugins that you use in order to see if the issue persists or ask the hosting company to further investigate.',
			...
			'options_strings'                => [
				...
				'cache_desc'                        => __( 'Clear all cached images by Optimole from this site. Useful if you updated them and Optimole shows the old version.', 'optimole-wp' ),
        'cache_desc_assets'                 => __( 'Clear all cached files(js,css) by Optimole from this site. Useful if you updated them and Optimole shows the old version.', 'optimole-wp' ),
        'cache_title'                       => __( 'Clear cached images', 'optimole-wp' ),
        'cache_title_assets'                => __( 'Clear cached files', 'optimole-wp' ),
