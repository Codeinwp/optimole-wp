...
<!-- /wp:image --> ';
	...
	public function test_page_images_process() {
		...
		$this->assertContains( '/cb:Q2KPUHHn/w:150/h:150/q:75/rt:fill/g:ce/f:avif/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $replaced_content );
		$this->assertContains( '/cb:Q2KPUHHn/w:150/h:150/q:eco/f:avif/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $replaced_content );
	}
	...
	public function test_image_processed() {
		...
		$this->assertContains('/cb:nLJ0vstD/w:200/h:200/q:mauto/rt:fill/g:nowe/process:' . self::$sample_attachement .'/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $my_size_image[0]);

		$this->assertContains( 'example.i.optimole.com', $image_thumbnail_size[0] );
		$this->assertContains( '/cb:Q2KPUHHn/w:150/h:150/q:mauto/rt:fill/g:ce/process:' . self::$sample_attachement .'/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $image_thumbnail_size[0] );

		$this->assertContains( 'example.i.optimole.com', $image_medium_size[0] );
		$this->assertContains( '/cb:Q2KPUHHn/w:300/h:200/q:mauto/process:' . self::$sample_attachement .'/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $image_medium_size[0] );
	...
	public function test_image_sync() {
		...
		$this->assertContains( 'example.i.optimole.com', $image_thumbnail_size[0] );
		$this->assertContains( '/cb:nLJ0vstD/w:150/h:150/q:mauto/rt:fill/g:ce/process:' . self::$sample_attachement .'/id:579c7f7707ce87caa65fdf50c238a117/http://example.org/1.jpg', $image_thumbnail_size[0] );

		$this->assertContains( 'example.i.optimole.com', $image_medium_size );
		$this->assertContains( '/cb:Q2KPUHHn/w:300/h:200/q:mauto/process:' . self::$sample_attachement .'/id:579c7f7707ce87caa65fdf50c238a117', $image_medium_size[0] );
	}
