describe( 'Check Divi Background Page', function () {
	...
	it( 'Divi slide that is not in view should have optml-bg-lazyloaded', function () {
		cy.get( '.entry-content' ).find( '.et_pb_slides > .et_pb_slide_4' ).eq( 0 ).should( 'have.css', 'background-image' ).and( 'match', /none/ );
	} );
	...
	it( 'Divi module that is not in view should have background', function () {
		cy.get( '.entry-content' ).find( '.et_pb_row_3' ).eq( 0 ).should( 'have.css', 'background-image' ).and( 'match', /none/ );
	} );
	it( 'Divi module that is not in view should have background', function () {
