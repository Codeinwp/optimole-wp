...
export const imagesNumber = () => (
	<svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55" fill="none">
		...
		<path d="M30.9707 25.0939L36.7915 29.8376" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M30.9711 25.0939L26.0669 30.2043" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M26.0665 30.2043L23.3853 28.4167" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M23.3856 28.4167L18.4585 32.5647" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
	</svg>
);
...
export const savedSize = () => (
	<svg xmlns="http://www.w3.org/2000/svg" width="56" height="55" viewBox="0 0 56 55" fill="none">
		...
		<path d="M22.9307 16.0416H36.6807" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M13.845 15.9606C13.8898 16.0053 13.8898 16.0779 13.845 16.1226C13.8003 16.1674 13.7277 16.1674 13.683 16.1226C13.6382 16.0779 13.6382 16.0053 13.683 15.9606C13.7277 15.9158 13.8003 15.9158 13.845 15.9606Z" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M22.9307 34.375H27.7432" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M13.845 34.2938C13.8898 34.3386 13.8898 34.4111 13.845 34.4559C13.8003 34.5006 13.7277 34.5006 13.683 34.4559C13.6382 34.4111 13.6382 34.3386 13.683 34.2938C13.7277 34.2491 13.8003 34.2491 13.845 34.2938Z" stroke="#577BF9" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
...
export const compressionPercentage = () => (
	<svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55" fill="none">
		...
		<path d="M43.5418 48.1251C41.0095 48.1251 38.9585 46.074 38.9585 43.5417C38.9585 41.0094 41.0095 38.9584 43.5418 38.9584C46.0741 38.9584 48.1252 41.0094 48.1252 43.5417C48.1252 46.074 46.0741 48.1251 43.5418 48.1251Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M27.4998 16.0417C24.9675 16.0417 22.9165 13.9906 22.9165 11.4583C22.9165 8.92604 24.9675 6.875 27.4998 6.875C30.0321 6.875 32.0832 8.92604 32.0832 11.4583C32.0832 13.9906 30.0321 16.0417 27.4998 16.0417Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M38.9585 11.4583C38.9585 8.92604 41.0095 6.875 43.5418 6.875C46.0741 6.875 48.1252 8.92604 48.1252 11.4583C48.1252 13.9906 46.0741 16.0417 43.5418 16.0417C41.0095 16.0417 38.9585 13.9906 38.9585 11.4583Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M30.7314 40.3104L40.3106 30.7312" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M14.6895 40.3104L24.2686 30.7312" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M30.7314 24.2687L40.3106 14.6896" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M22.9165 27.5C22.9165 24.9677 24.9675 22.9166 27.4998 22.9166C30.0321 22.9166 32.0832 24.9677 32.0832 27.5C32.0832 30.0323 30.0321 32.0833 27.4998 32.0833C24.9675 32.0833 22.9165 30.0323 22.9165 27.5Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M14.6895 24.2687L24.2686 14.6896" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M11.4583 32.0833C8.92604 32.0833 6.875 30.0323 6.875 27.5C6.875 24.9677 8.92604 22.9166 11.4583 22.9166C13.9906 22.9166 16.0417 24.9677 16.0417 27.5C16.0417 30.0323 13.9906 32.0833 11.4583 32.0833Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M16.0417 43.5417C16.0417 46.074 13.9906 48.1251 11.4583 48.1251C8.92604 48.1251 6.875 46.074 6.875 43.5417C6.875 41.0094 8.92604 38.9584 11.4583 38.9584C13.9906 38.9584 16.0417 41.0094 16.0417 43.5417Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
		<path d="M11.4583 16.0417C8.92604 16.0417 6.875 13.9906 6.875 11.4583C6.875 8.92604 8.92604 6.875 11.4583 6.875C13.9906 6.875 16.0417 8.92604 16.0417 11.4583C16.0417 13.9906 13.9906 16.0417 11.4583 16.0417Z" stroke="#577BF9" stroke-width="1.97917" stroke-linecap="round" stroke-linejoin="round"/>
	</svg>
);
...
export const traffic = () => (
	<svg width="55" height="55" viewBox="0 0 64 64" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" svg-inline="" role="presentation" focusable="false">
		<path data-v-767b24d4="" d="M23.997 28c0 2.947-4.178 5.333-9.333 5.333S5.334 30.944 5.334 28" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 28c0 2.947-4.178 5.333-9.333 5.333S5.334 30.944 5.334 28" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 28c0 2.947-4.178 5.333-9.333 5.333S5.334 30.944 5.334 28" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M23.997 36c0 2.947-4.178 5.333-9.333 5.333S5.334 38.944 5.334 36" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M50.667 56H40a5.332 5.332 0 01-5.333-5.333V13.333A5.332 5.332 0 0140 8h10.667A5.332 5.332 0 0156 13.333v37.334A5.332 5.332 0 0150.667 56z" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M50.667 56H40a5.332 5.332 0 01-5.333-5.333V13.333A5.332 5.332 0 0140 8h10.667A5.332 5.332 0 0156 13.333v37.334A5.332 5.332 0 0150.667 56z" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M50.667 56H40a5.332 5.332 0 01-5.333-5.333V13.333A5.332 5.332 0 0140 8h10.667A5.332 5.332 0 0156 13.333v37.334A5.332 5.332 0 0150.667 56z" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M24 32h10.667M24 32h10.667" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M24 32h10.667" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 16H48M42.667 16H48" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 16H48" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 26.667H48M42.667 26.667H48" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 26.667H48" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 37.333H48M42.667 37.333H48" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 37.333H48" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 48H48M42.667 48H48" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M42.667 48H48" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c0 2.947 4.179 5.333 9.334 5.333C19.82 25.333 24 22.947 24 20" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c0 2.947 4.179 5.333 9.334 5.333C19.82 25.333 24 22.947 24 20" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c0 2.947 4.179 5.333 9.334 5.333C19.82 25.333 24 22.947 24 20" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c.003-2.944 4.182-5.333 9.334-5.333 5.152 0 9.333 2.386 9.33 5.333v24c0 2.947-4.178 5.333-9.333 5.333S5.334 46.944 5.334 44V20v0z" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c.003-2.944 4.182-5.333 9.334-5.333 5.152 0 9.333 2.386 9.33 5.333v24c0 2.947-4.178 5.333-9.333 5.333S5.334 46.944 5.334 44V20v0z" stroke="#EDF0FF" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
		<path data-v-767b24d4="" d="M5.333 20c.003-2.944 4.182-5.333 9.334-5.333 5.152 0 9.333 2.386 9.33 5.333v24c0 2.947-4.178 5.333-9.333 5.333S5.334 46.944 5.334 44V20v0z" stroke="#577BF9" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path>
	</svg>
);
...
export const rollback = (
	<svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path d="M5 15C2.79086 15 1 13.2091 1 11C1 9.09295 2.33457 7.4976 4.12071 7.09695C4.04169 6.74395 4 6.37684 4 6C4 3.23858 6.23858 1 9 1C11.4193 1 13.4373 2.71825 13.9002 5.00098C13.9334 5.00033 13.9666 5 14 5C16.7614 5 19 7.23858 19 10C19 12.419 17.2822 14.4367 15 14.9M7 18L10 21M10 21L13 18M10 21V9" stroke="#577BF9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
	</svg>
);
...
export const cloudDownload = (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 13v8l-4-4"/><path d="m12 21 4-4"/><path d="M4.393 15.269A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.436 8.284"/></svg>
);

export const chartBarDecreasing = (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 11h8"/><path d="M7 16h3"/><path d="M7 6h12"/></svg>
);
