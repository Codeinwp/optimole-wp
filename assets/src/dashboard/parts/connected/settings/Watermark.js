			...
			<div style={containerStyle}>
				<div className="mb-4 space-y-2">
					<div className="flex items-center gap-2 align-center">
						...
						<span className="text-gray-700 text-center">{options_strings.watermark_info_1}</span>
					</div>
					<div className="flex items-center gap-2 align-center">
						<div className="w-2 h-2 bg-gray-900 rounded-full flex-shrink-0"></div>
						<span className="text-gray-700 text-center ">{options_strings.watermark_info_2}</span>
					</div>
					<div className="flex items-center gap-2 align-center">
						<div className="w-2 h-2 bg-gray-900 rounded-full flex-shrink-0"></div>
						<span className="text-gray-700 text-center">{options_strings.watermark_info_3}</span>
					</div>
				</div>
				...
				<p className="text-gray-500" style={{ gap: 0 }}>
