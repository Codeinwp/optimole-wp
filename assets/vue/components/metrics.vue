    ...
    <ul class="optml-side-by-side optml-metric-wrapper">
      ...
      <li class="optml-metric">
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="55" viewBox="0 0 56 55" fill="none">
          ...
          <p class="optml-font is-size-5 has-text-weight-bold">
            {{ (getMetric('saved_size')/1000).toFixed(2)}}MB/&infin;
          </p>
          <p class="is-size-6">
            Saved file size
          </p>
...
export default {
  ...
  methods: {
    getMetric ( metric ) {
      if ( Object.prototype.hasOwnProperty.call( this.userData, metric ) ) {
        return this.userData[metric];
      }
