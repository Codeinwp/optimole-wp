		...
		<div class="header has-text-centered level" style="padding-top: 1em; padding-bottom: 2em;">
			...
			<div class="level-left">
				<a class="logo level-item" href="https://optimole.com" target="_blank">
					<figure class="image is-64x64 is-hidden-touch">
				...
				<h3 class="has-text-centered has-text-dark is-size-4 is-size-3-widescreen is-size-5-touch level-item">
					<span class="has-text-weight-bold optml-font">
					Optimole
					</span>
				</h3>
			</div>
...
<path d="M4.00127 14.3639C0.486555 10.8492 0.486555 5.15071 4.00127 1.63599M16.7292 1.63599C20.2439 5.15071 20.2439 10.8492 16.7292 14.3639M6.8297 11.5355C4.87708 9.58286 4.87708 6.41704 6.8297 4.46441M13.9008 4.46441C15.8534 6.41704 15.8534 9.58286 13.9008 11.5355M11.3652 7.99995C11.3652 8.55223 10.9175 8.99995 10.3652 8.99995C9.81295 8.99995 9.36523 8.55223 9.36523 7.99995C9.36523 7.44766 9.81295 6.99995 10.3652 6.99995C10.9175 6.99995 11.3652 7.44766 11.3652 7.99995Z" stroke="#6D955A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
					...
					<div v-else class="is-size-7 optml-side-by-side" style="color: #E77777;">
            <div style="bottom: -2px; position: relative;">{{strings.not_connected}}</div>
            <div style="margin-left:15px;">
